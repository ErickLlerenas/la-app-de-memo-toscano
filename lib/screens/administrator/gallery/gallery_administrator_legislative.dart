...
class GalleryAdministratorLegislative extends StatelessWidget{
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => NewGallery(type:'gallery_legislative')));
            },
            child: Icon(Icons.add)),
        body: StreamBuilder(
            stream: Firestore.instance.collection('gallery_legislative').snapshots(),
          ...
          actions: <Widget>[
            FlatButton(
              ...
              onPressed: () {
                ...
                Firestore.instance
                    .collection('gallery_legislative')
                    .document(document)
                    .delete()
                    .then((value) => {});
              },
