...
class GalleryAdministrator extends StatefulWidget {
  @override
  _GalleryAdministratorState createState() => _GalleryAdministratorState();
}

class _GalleryAdministratorState extends State<GalleryAdministrator> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        floatingActionButton: FloatingActionButton(
            ...
            onPressed: () {
              Navigator.push(
                  context, MaterialPageRoute(builder: (context) => NewGallery(type:'gallery')));
            },
